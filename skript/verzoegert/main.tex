...
Es gibt diverse weitere Anwendungen für verzögerte Differentialgleichungen in Physik, Chemie und Biologie (vgl. \cite{verzoegert:erneux}). %todo ev. Grafik Population oder so
...
\input{verzoegert/inp/grundlagen.tex}
\input{verzoegert/inp/el_nino_dde.tex}
\input{verzoegert/inp/numerische_loesung.tex}
\input{verzoegert/inp/auswertung.tex}
