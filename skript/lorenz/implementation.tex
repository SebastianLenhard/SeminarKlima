...
Der zweite Ansatz ist, eine Diskretisierung vorzunehmen und den Computer f"ur jeden definierten Zeitpunkt die Resultate der Gleichungen ausrechnen zu lassen. Dies ist auch der in dieser Arbeit gew"ahlte Ansatz, der im Folgenden genauer beschrieben wird. 
