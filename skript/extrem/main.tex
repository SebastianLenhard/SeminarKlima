...
%\begin{definition}
%Die Dichte einer diskreten Verteilung, wird durch Aufsummieren der Wahrscheinlichkeiten %der einzelnen Elementarereignisse berechnet.
%\end{definition}
...
%Hierfür werden die Wahrscheinlichkeiten aufsummiert 
...
=======
\includegraphics[width=1.0\textwidth]{extrem/JahresMittel.pdf}
\caption{BLaBLa}
\label{JahresMittel}
\end{figure}
